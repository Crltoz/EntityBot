      ...
      let options = {
        ...
        const req = https.get(options, function (res) {
          ...
          res.on('data', function (chunk) {
            ...
            con.query(`DELETE * FROM santuario WHERE ID = 1`)
...
{
  //perks de killer
  if(variable == "a_nurses_calling") return ObtenerPerkKiller(0)
  if(variable == "agitation") return ObtenerPerkKiller(1)
  if(variable == "bamboozle") return ObtenerPerkKiller(2)
  if(variable == "bbq_and_chilli") return ObtenerPerkKiller(3)
  if(variable == "beast_of_prey") return ObtenerPerkKiller(4)
  if(variable == "bitter_murmur") return ObtenerPerkKiller(5)
  if(variable == "blood_echo") return ObtenerPerkKiller(6)
  if(variable == "blood_warden") return ObtenerPerkKiller(7)
  if(variable == "bloodhound") return ObtenerPerkKiller(8)
  if(variable == "brutal_strength") return ObtenerPerkKiller(9)
  if(variable == "corrupt_intervention") return ObtenerPerkKiller(10)
  if(variable == "coulrophobia") return ObtenerPerkKiller(11)
  if(variable == "cruel_limits") return ObtenerPerkKiller(12)
  if(variable == "dark_devotion") return ObtenerPerkKiller(13)
  if(variable == "dead_mans_switch") return ObtenerPerkKiller(14)
  ...
  if(variable == "fire_up") return ObtenerPerkKiller(21)
  if(variable == "forced_penance") return ObtenerPerkKiller(22)
  if(variable == "franklins_demise") return ObtenerPerkKiller(23)
  if(variable == "furtive_chase") return ObtenerPerkKiller(24)
  if(variable == "gearhead") return ObtenerPerkKiller(25)
  if(variable == "hangmans_trick") return ObtenerPerkKiller(26)
  if(variable == "hex_devour_hope") return ObtenerPerkKiller(27)
  if(variable == "hex_haunted_ground") return ObtenerPerkKiller(28)
  if(variable == "hex_huntress_lullaby") return ObtenerPerkKiller(29)
  if(variable == "hex_no_one_escapes_death") return ObtenerPerkKiller(30)
  if(variable == "hex_retribution") return ObtenerPerkKiller(31)
  ...
  if(variable == "im_all_ears") return ObtenerPerkKiller(35)
  if(variable == "infectious_fright") return ObtenerPerkKiller(36)
  if(variable == "insidious") return ObtenerPerkKiller(37)
  if(variable == "iron_grasp") return ObtenerPerkKiller(38)
  if(variable == "iron_maiden") return ObtenerPerkKiller(39)
  if(variable == "knock_out") return ObtenerPerkKiller(40)
  if(variable == "lightborn") return ObtenerPerkKiller(41)
  if(variable == "mad_grit") return ObtenerPerkKiller(42)
  if(variable == "make_your_choice") return ObtenerPerkKiller(43)
  if(variable == "mindbreaker") return ObtenerPerkKiller(44)
  if(variable == "monitor_and_abuse") return ObtenerPerkKiller(45)
  ...
  if(variable == "overwhelming_presence") return ObtenerPerkKiller(49)
  ...
  if(variable == "remember_me") return ObtenerPerkKiller(54)
  ...
  if(variable == "spirit_fury") return ObtenerPerkKiller(59)
  ...
  if(variable == "territorial_imperative") return ObtenerPerkKiller(63)
  if(variable == "tinkerer") return ObtenerPerkKiller(64)
  if(variable == "thanatophobia") return ObtenerPerkKiller(65)
  if(variable == "thrilling_tremors") return ObtenerPerkKiller(66)
  if(variable == "trail_of_torment") return ObtenerPerkKiller(67)
  ...
  if(variable == "zanshin_tactics") return ObtenerPerkKiller(71)
  //Perks de survivor
  ...
  if(variable == "any_means_necessary") return ObtenerPerkSurv(4)
  ...
  if(variable == "better_together") return ObtenerPerkSurv(8)
  if(variable == "blood_pact") return ObtenerPerkSurv(9)
  if(variable == "boil_over") return ObtenerPerkSurv(10)
  if(variable == "bond") return ObtenerPerkSurv(11)
  if(variable == "borrowed_time") return ObtenerPerkSurv(12)
  ...
  if(variable == "buckle_up") return ObtenerPerkSurv(16)
  ...
  if(variable == "dead_hard") return ObtenerPerkSurv(21)
  if(variable == "decisive_strike") return ObtenerPerkSurv(22)
  ...
  if(variable == "flip_flop") return ObtenerPerkSurv(30)
  if(variable == "for_the_people") return ObtenerPerkSurv(31)
  if(variable == "head_on") return ObtenerPerkSurv(32)
  if(variable == "hope") return ObtenerPerkSurv(33)
  if(variable == "inner_strength") return ObtenerPerkSurv(34)
  ...
  if(variable == "lucky_break") return ObtenerPerkSurv(41)
  if(variable == "mettle_of_man") return ObtenerPerkSurv(42)
  if(variable == "no_mither") return ObtenerPerkSurv(43)
  if(variable == "no_one_left_behind") return ObtenerPerkSurv(44)
  if(variable == "object_of_obsession") return ObtenerPerkSurv(45)
  if(variable == "off_the_record") return ObtenerPerkSurv(46)
  ...
  if(variable == "red_herring") return ObtenerPerkSurv(54)
  if(variable == "repressed_alliance") return ObtenerPerkSurv(55)
  if(variable == "resilience") return ObtenerPerkSurv(56)
  if(variable == "saboteur") return ObtenerPerkSurv(57)
  if(variable == "second_wind") return ObtenerPerkSurv(58)
  ...
  if(variable == "wake_up") return ObtenerPerkSurv(76)
  if(variable == "well_make_it") return ObtenerPerkSurv(77)
  if(variable == "were_gonna_live_forever") return ObtenerPerkSurv(78)
  if(variable == "windows_of_opportunity") return ObtenerPerkSurv(79)
  return;
}
