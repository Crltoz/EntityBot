                  ...
                  } else
                  {
                    if((parseInt(usa.getTime())-parseInt(update_att)) < 60000*60*3)
                    {
                      ...
                      } else if(args[0].toLowerCase() == 'survivor') 
                      {
                        ...
                        const embedd = new Discord.RichEmbed()
                        .setColor('#FF0000')
                        .setTitle('Estadisticas de Superviviente de '+name)
                        .setAuthor(message.member.user.tag, message.member.user.avatarURL)
                        .setThumbnail('https://i.imgur.com/DG6fm1A.png')
                        .addField('<:bp:724724401333076071> Puntos de sangre totales:', Coma(bloodpoints), true)
                        .addField('Horas de juego:', playtime, true)
                        .addBlankField()
...
function obtenervalorkill(variable, canal, usuario, server, sid, usa)
{
  ...
  .addField('Horas de juego:', playtime_2/60, true)
  .addBlankField()
  ...
  .addField('<:Icons_Bgen:739182106474709042> Sacrificiaste a todos después del último generador:', killed_sacrificed_afterlastgen_2,true)
