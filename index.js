  ...
  if(command == 'calcular')
  {
    ...
    return;
     ...
     if(command == 'ayuda')
     {
      ...
      .addField('/calcular [Killer o Survivor]', 'Podrás calcular cuánto cuesta tener todas las perks de tú superviviente o asesino, el bot luego te preguntará las perks que tengas para hacer el cálculo.')
